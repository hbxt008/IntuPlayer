...
from PyQt6.QtCore import Qt, QUrl, QDir, QTime
...
class AudioPlayer(QMainWindow):
    ...
    def __init__(self):
        ...
        # 1. 更改为 ClickableSlider 以支持鼠标点击跳转
        ...
        # 2. 从布局中移除 self.device_combo 并隐藏，仅在点击按钮时弹出
        # full_layout.addWidget(self.device_combo) # 移除
    ...
    def change_audio_device(self, index):
        # 这里的逻辑与原代码保持一致，只是多了一个信号连接，用于在选中后自动隐藏 QComboBox
